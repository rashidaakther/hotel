                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="{{ route('OfferList') }}" class="btn btn-secondary"><- Back To Offer List</a>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="Offer_percent" required>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea id="" rows="10" class="form-control" name="details" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
