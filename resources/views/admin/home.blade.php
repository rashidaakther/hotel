@extends('layouts.app')
@section('title', 'i-Suites Residence & Resturant')
@section('contents')
 <!-- is search -->
    ...
    <div class="gdlr-content">
        ...
        <div class="with-sidebar-wrapper">
                        ...
                        <div id="P_MS5af5c0e887f3f" class="master-slider-parent ms-parent-id-2">
                            ...
                            <div id="MS5af5c0e887f3f" class="master-slider ms-skin-default">
                                ...
                                <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                    <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/hotel/501.jpg">
                                ...
                                <div class="ms-slide" data-delay="3" data-fill-mode="fill">
                                    <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/hotel/502.jpg">
                                    ...
                                    {{-- <div class="ms-layer  msp-cn-1-7" style="" data-duration="975" data-delay="1137" data-ease="easeOutQuint" data-offset-x="176" data-offset-y="176" data-origin="ml" data-position="normal">
                                        The Finest Spa On Earth</div> --}}


                                </div>
                                <div class="ms-slide" data-delay="3" data-fill-mode="fill">
                                    <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/hotel/506.jpg">
                        ...
                        <div class="gdlr-hotel-availability-wrapper" style="margin-bottom: 20px;">
                            <form class="gdlr-hotel-availability gdlr-item" id="gdlr-hotel-availability" method="post" action="#">
                                ...
                                <div class="gdlr-reservation-field gdlr-resv-combobox "><span class="gdlr-reservation-field-title">Children</span>
                                    <div class="gdlr-combobox-wrapper"><select name="gdlr-children-number[]"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></div>
                                </div>
                                <div class="gdlr-hotel-availability-submit"><input type="hidden" name="hotel_data" value="1"><input type="hidden" name="gdlr-room-number" value="1"><input type="submit" class="gdlr-reservation-bar-button gdlr-button with-border" value="Check Availability"></div>
                                <div class="clear"></div>
                            </form>
                        </div>
                        <div class="clear"></div>
                ...
                <div class="gdlr-color-wrapper  gdlr-show-all no-skin" style="background-color: #0a0a0a; padding-top: 60px; ">
                    <div class="container">
                        <div class="four columns">
                            <div class="gdlr-ux column-service-ux">
                                <div class="gdlr-item gdlr-column-service-item gdlr-type-2">
                                    <div class="column-service-image"><img src="images/hotel/qulity.webp" alt="" width="500" height="257"></div>
                        ...
                        <div class="four columns">
                            <div class="gdlr-ux column-service-ux">
                                <div class="gdlr-item gdlr-column-service-item gdlr-type-2">
                                    <div class="column-service-image"><img src="images/hotel/gym.webp" alt="" width="500" height="257"></div>
                                    <div class="column-service-content-wrapper">
                                        <h3 class="column-service-title">Spa centre and Gym</h3>
                                        <div class="column-service-divider"></div>
                                        <div class="column-service-content gdlr-skin-content">
                                            <p>Moreover a fully equipped gymnasium to make your time more enjoyable. The Recreation complex gives guests an unmatched opportunity to reinvigorate themselves.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="four columns">
                            <div class="gdlr-ux column-service-ux">
                                <div class="gdlr-item gdlr-column-service-item gdlr-type-2">
                                    <div class="column-service-image"><img src="images/hotel/rooftop.webp" alt="" width="500" height="257"></div>
                                    <div class="column-service-content-wrapper">
                    ...
                    <div class="container">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-center gdlr-nav-container ">
                            <div class="gdlr-item-title-head">
                                ...
                                <div class="clear"></div>
                            </div><a class="gdlr-item-title-link" href="#">View All Rooms<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></div>
                                    ...
                                    <div class="flexslider" data-type="carousel" data-nav-container="room-item-wrapper" data-columns="3">
                                        <ul class="slides">
                                            <li class="gdlr-item gdlr-modern-room">
                                                <div class="gdlr-room-thumbnail"><a href="{{ route('accommodation')}}"><img src="upload/photodune-2676493-suite-bed-room-with-balcony-of-a-luxury-resort-m-700x400.jpg" alt="" width="700" height="400"></a></div>
                                                <h3 class="gdlr-room-title"><a href="{{ route('accommodation')}}">Premium Suites</a></h3><a href="{{ route('accommodation')}}" class="gdlr-room-detail">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></li>
                                            <li class="gdlr-item gdlr-modern-room">
                                                <div class="gdlr-room-thumbnail"><a href="{{ route('accommodation')}}"><img src="images/hotel/501.jpg" alt="" width="700" height="400"></a></div>
                                                <h3 class="gdlr-room-title"><a href="{{ route('accommodation')}}">Super Deluxe Couple</a></h3><a href="{{ route('accommodation')}}" class="gdlr-room-detail">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></li>
                                            <li class="gdlr-item gdlr-modern-room">
                                                <div class="gdlr-room-thumbnail"><a href="r{{ route('accommodation')}}"><img src="images/hotel/502.jpg" alt="" width="700" height="400"></a></div>
                                                <h3 class="gdlr-room-title"><a href="{{ route('accommodation')}}">Deluxe Couple</a></h3><a href="{{ route('accommodation')}}" class="gdlr-room-detail">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></li>
                                            <li class="gdlr-item gdlr-modern-room">
                                                <div class="gdlr-room-thumbnail"><a href="room/grand-superior-room-two-king-beds/index.html"><img src="images/hotel/503.jpg" alt="" width="700" height="400"></a></div>
                                                <h3 class="gdlr-room-title"><a href="{{ route('accommodation')}}">Deluxe Twin</a></h3><a href="{{ route('accommodation')}}" class="gdlr-room-detail">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></li>
                                            <li class="gdlr-item gdlr-modern-room">
                                                <div class="gdlr-room-thumbnail"><a href="{{ route('accommodation')}}"><img src="images/hotel/5022.jpg" alt="" width="700" height="400"></a></div>
                                                <h3 class="gdlr-room-title"><a href="{{ route('accommodation')}}">Eeconomy Single</a></h3><a href="{{ route('accommodation')}}" class="gdlr-room-detail">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></li>
            ...
            <section id="content-section-5">
                <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all gdlr-skin-dark-skin" id="gdlr-parallax-wrapper-2" data-bgspeed="0.1" style="background-image: url('upload/about-bg.jpg'); padding-top: 160px; padding-bottom: 110px; ">
                    <div class="container">
                                            ...
                                            <article id="post-862" class="post-862 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-fit-row tag-blog tag-link tag-news">
                                                <div class="gdlr-standard-style">
                                                    ...
                                                    <header class="post-header">
                                                        <h3 class="gdlr-blog-title"><a href="javascript:void(0)">Coral Thai Spa</a></h3>

                                                        <div class="gdlr-blog-excerpt">The name CORAL word meaning Substance. Rated aas one of the best hotel SPA in Chittagong. 
                                        ...
                                        <div class="gdlr-ux gdlr-blog-widget-ux">
                                            <article id="post-859" class="post-859 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-fit-row">
                                                <div class="gdlr-standard-style">
                                                    ...
                                                    <header class="post-header">
                                                        <h3 class="gdlr-blog-title"><a href="javascript:void(0)">Business Center</a></h3>

                                                        <div class="gdlr-blog-excerpt">Exclusive Business Center in ground floor for each and every guest open for 24x7.
                                                            </div>
                                                        <div class="clear"></div>
                                                    </header>
                                                    <!-- entry-header -->
                                        ...
                                        <div class="gdlr-ux gdlr-blog-widget-ux">
                                            <article id="post-2211" class="post-2211 post type-post status-publish format-gallery has-post-thumbnail hentry category-blog category-life-style category-news-article tag-blog tag-gallery-thumbnail tag-life-style tag-news post_format-post-format-gallery">
                                                <div class="gdlr-standard-style">
                                                    ...
                                                    <header class="post-header">
                                                        <h3 class="gdlr-blog-title"><a href="javascript:void(0)">Barber Shop</a></h3>

                                                        <div class="gdlr-blog-excerpt">The Saloon by Wellpark allows you to immerse your mind and body. Serving you by professional trained on a pathway of renewal which makes you smoothing atmosphere in your mind and body.
                                                            </div>
                                                        <div class="clear"></div>
                                                    </header>
                                                    <!-- entry-header -->
                        ...
                        <div class="six columns">
                            ...
                            <div class="gdlr-gallery-item gdlr-item">
                                <div class="gallery-column six columns">
                                    <div class="gallery-item"><a href="upload/photodune-7751505-luxury-home-with-swimming-pool-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-7751505-luxury-home-with-swimming-pool-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-1231437-tropical-pool-bar-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-1231437-tropical-pool-bar-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-1576481-relaxing-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-1576481-relaxing-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-2650397-sailing-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-2650397-sailing-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-4076311-interior-of-modern-comfortable-hotel-room-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-4076311-interior-of-modern-comfortable-hotel-room-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="clear"></div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-3973259-hotel-room-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-3973259-hotel-room-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/photodune-2676493-suite-bed-room-with-balcony-of-a-luxury-resort-m.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/photodune-2676493-suite-bed-room-with-balcony-of-a-luxury-resort-m-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/Fotolia_34317913_Subscription_Monthly_XXL.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/Fotolia_34317913_Subscription_Monthly_XXL-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="gallery-column three columns">
                                    <div class="gallery-item"><a href="upload/Fotolia_44778217_Subscription_Monthly_XXL.jpg" data-fancybox-group="gdlr-gal-1" data-rel="fancybox"><img src="upload/Fotolia_44778217_Subscription_Monthly_XXL-400x400.jpg" alt="" width="400" height="400"></a></div>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
